    ...
    var R = Resource(
      ...
      { 'id': '@id' },
      {
        ...
        "::findById::Client::instruments": {
          ...
          url: urlBase + "/Clients/:id/instruments/:fk",
          method: "GET"
        },

        // INTERNAL. Use Client.instruments.destroyById() instead.
        "::destroyById::Client::instruments": {
          params: {
          'fk': '@fk'
          },
          url: urlBase + "/Clients/:id/instruments/:fk",
        ...
        // INTERNAL. Use Client.instruments.updateById() instead.
        "::updateById::Client::instruments": {
          params: {
          'fk': '@fk'
          },
          url: urlBase + "/Clients/:id/instruments/:fk",
        ...
        // INTERNAL. Use Client.instruments.link() instead.
        "::link::Client::instruments": {
          params: {
          'fk': '@fk'
          },
          url: urlBase + "/Clients/:id/instruments/rel/:fk",
          method: "PUT"
        },

        // INTERNAL. Use Client.instruments.unlink() instead.
        "::unlink::Client::instruments": {
          params: {
          'fk': '@fk'
          },
          url: urlBase + "/Clients/:id/instruments/rel/:fk",
        ...
        // INTERNAL. Use Client.instruments.exists() instead.
        "::exists::Client::instruments": {
          params: {
          'fk': '@fk'
          },
          url: urlBase + "/Clients/:id/instruments/rel/:fk",
        ...
        // INTERNAL. Use Client.instruments() instead.
        "::get::Client::instruments": {
          isArray: true,
          url: urlBase + "/Clients/:id/instruments",
          method: "GET"
        },

        // INTERNAL. Use Client.instruments.create() instead.
        "::create::Client::instruments": {
          url: urlBase + "/Clients/:id/instruments",
          method: "POST"
        },

        // INTERNAL. Use Client.instruments.createMany() instead.
        "::createMany::Client::instruments": {
          isArray: true,
          url: urlBase + "/Clients/:id/instruments",
          method: "POST"
        },

        // INTERNAL. Use Client.instruments.destroyAll() instead.
        "::delete::Client::instruments": {
          url: urlBase + "/Clients/:id/instruments",
          method: "DELETE"
        },

        // INTERNAL. Use Client.instruments.count() instead.
        "::count::Client::instruments": {
          url: urlBase + "/Clients/:id/instruments/count",
          method: "GET"
        },

        // INTERNAL. Use InstrumentTracking.instrument() instead.
        "::get::InstrumentTracking::instrument": {
          url: urlBase + "/InstrumentTrackings/:id/instrument",
          method: "GET"
        },
      }
    );
  ...
  ['LoopBackResource', 'LoopBackAuth', '$injector', function(Resource, LoopBackAuth, $injector) {
    var R = Resource(
      ...
      { 'id': '@id' },
      {
        ...
        // INTERNAL. Use Client.instruments.findById() instead.
        "prototype$__findById__instruments": {
          params: {
          'fk': '@fk'
          },
          url: urlBase + "/Clients/:id/instruments/:fk",
        ...
        // INTERNAL. Use Client.instruments.destroyById() instead.
        "prototype$__destroyById__instruments": {
          params: {
          'fk': '@fk'
          },
          url: urlBase + "/Clients/:id/instruments/:fk",
        ...
        // INTERNAL. Use Client.instruments.updateById() instead.
        "prototype$__updateById__instruments": {
          params: {
          'fk': '@fk'
          },
          url: urlBase + "/Clients/:id/instruments/:fk",
        ...
        // INTERNAL. Use Client.instruments.unlink() instead.
        "prototype$__unlink__instruments": {
          params: {
          'fk': '@fk'
          },
          url: urlBase + "/Clients/:id/instruments/rel/:fk",
        ...
        // INTERNAL. Use Client.instruments.exists() instead.
        "prototype$__exists__instruments": {
          params: {
          'fk': '@fk'
          },
          url: urlBase + "/Clients/:id/instruments/rel/:fk",
        ...
        // INTERNAL. Use Client.instruments.create() instead.
        "prototype$__create__instruments": {
          url: urlBase + "/Clients/:id/instruments",
          method: "POST"
        },

        // INTERNAL. Use Client.instruments.destroyAll() instead.
        "prototype$__delete__instruments": {
          url: urlBase + "/Clients/:id/instruments",
          method: "DELETE"
        },

        // INTERNAL. Use Client.instruments.count() instead.
        "prototype$__count__instruments": {
          url: urlBase + "/Clients/:id/instruments/count",
          method: "GET"
        },
        ...
        // INTERNAL. Use InstrumentTracking.user() instead.
        "::get::InstrumentTracking::user": {
          url: urlBase + "/InstrumentTrackings/:id/user",
          method: "GET"
        },
    ...
    */
    ...
    /**
     * @ngdoc object
     * @name lbServices.Client.instruments
     * @header lbServices.Client.instruments
     * @object
     * @description
     *
     * The object `Client.instruments` groups methods
     * manipulating `Instrument` instances related to `Client`.
     *
     * Call {@link lbServices.Client#instruments Client.instruments()}
     * to query all related instances.
     */
         ...
         * </em>
         */
        R.instruments = function() {
          var TargetResource = $injector.get("Instrument");
          var action = TargetResource["::get::Client::instruments"];
          return action.apply(R, arguments);
        };

        /**
         * @ngdoc method
         * @name lbServices.Client.instruments#count
         * @methodOf lbServices.Client.instruments
         *
         * @description
         *
         * Counts instruments of Client.
         *
         * @param {Object=} parameters Request parameters.
         *
         *  - `id` – `{*}` - User id
         ...
         *  - `count` – `{number=}` - 
         */
        R.instruments.count = function() {
          var TargetResource = $injector.get("Instrument");
          var action = TargetResource["::count::Client::instruments"];
          return action.apply(R, arguments);
        };

        /**
         * @ngdoc method
         * @name lbServices.Client.instruments#create
         * @methodOf lbServices.Client.instruments
         *
         * @description
         *
         * Creates a new instance in instruments of this model.
         *
         * @param {Object=} parameters Request parameters.
         *
         *  - `id` – `{*}` - User id
         ...
         * </em>
         */
        R.instruments.create = function() {
          var TargetResource = $injector.get("Instrument");
          var action = TargetResource["::create::Client::instruments"];
          return action.apply(R, arguments);
        };

        /**
         * @ngdoc method
         * @name lbServices.Client.instruments#createMany
         * @methodOf lbServices.Client.instruments
         *
         * @description
         *
         ...
         * </em>
         */
        R.instruments.createMany = function() {
          var TargetResource = $injector.get("Instrument");
          var action = TargetResource["::createMany::Client::instruments"];
          return action.apply(R, arguments);
        };

        /**
         * @ngdoc method
         * @name lbServices.Client.instruments#destroyAll
         * @methodOf lbServices.Client.instruments
         *
         * @description
         *
         * Deletes all instruments of this model.
         *
         * @param {Object=} parameters Request parameters.
         *
         *  - `id` – `{*}` - User id
         ...
         * This method returns no data.
         */
        R.instruments.destroyAll = function() {
          var TargetResource = $injector.get("Instrument");
          var action = TargetResource["::delete::Client::instruments"];
          return action.apply(R, arguments);
        };

        /**
         * @ngdoc method
         * @name lbServices.Client.instruments#destroyById
         * @methodOf lbServices.Client.instruments
         *
         * @description
         *
         * Delete a related item by id for instruments.
         *
         * @param {Object=} parameters Request parameters.
         *
         *  - `id` – `{*}` - User id
         *
         *  - `fk` – `{*}` - Foreign key for instruments
         *
         * @param {function(Object,Object)=} successCb
         *   Success callback with two arguments: `value`, `responseHeaders`.
         *
         ...
         * This method returns no data.
         */
        R.instruments.destroyById = function() {
          var TargetResource = $injector.get("Instrument");
          var action = TargetResource["::destroyById::Client::instruments"];
          return action.apply(R, arguments);
        };

        /**
         * @ngdoc method
         * @name lbServices.Client.instruments#exists
         * @methodOf lbServices.Client.instruments
         *
         * @description
         *
         * Check the existence of instruments relation to an item by id.
         *
         * @param {Object=} parameters Request parameters.
         *
         *  - `id` – `{*}` - User id
         ...
         * </em>
         */
        R.instruments.exists = function() {
          var TargetResource = $injector.get("Instrument");
          var action = TargetResource["::exists::Client::instruments"];
          return action.apply(R, arguments);
        };

        /**
         * @ngdoc method
         * @name lbServices.Client.instruments#findById
         * @methodOf lbServices.Client.instruments
         *
         * @description
         *
         * Find a related item by id for instruments.
         *
         * @param {Object=} parameters Request parameters.
         *
         *  - `id` – `{*}` - User id
         ...
         * </em>
         */
        R.instruments.findById = function() {
          var TargetResource = $injector.get("Instrument");
          var action = TargetResource["::findById::Client::instruments"];
          return action.apply(R, arguments);
        };

        /**
         * @ngdoc method
         * @name lbServices.Client.instruments#link
         * @methodOf lbServices.Client.instruments
         *
         * @description
         *
         * Add a related item by id for instruments.
         *
         * @param {Object=} parameters Request parameters.
         *
         *  - `id` – `{*}` - User id
         ...
         * </em>
         */
        R.instruments.link = function() {
          var TargetResource = $injector.get("Instrument");
          var action = TargetResource["::link::Client::instruments"];
          return action.apply(R, arguments);
        };

        /**
         * @ngdoc method
         * @name lbServices.Client.instruments#unlink
         * @methodOf lbServices.Client.instruments
         *
         * @description
         *
         * Remove the instruments relation to an item by id.
         *
         * @param {Object=} parameters Request parameters.
         *
         *  - `id` – `{*}` - User id
         ...
         * This method returns no data.
         */
        R.instruments.unlink = function() {
          var TargetResource = $injector.get("Instrument");
          var action = TargetResource["::unlink::Client::instruments"];
          return action.apply(R, arguments);
        };

        /**
         * @ngdoc method
         * @name lbServices.Client.instruments#updateById
         * @methodOf lbServices.Client.instruments
         *
         * @description
         *
         * Update a related item by id for instruments.
         *
         * @param {Object=} parameters Request parameters.
         *
         *  - `id` – `{*}` - User id
         ...
         * </em>
         */
        R.instruments.updateById = function() {
          var TargetResource = $injector.get("Instrument");
          var action = TargetResource["::updateById::Client::instruments"];
          return action.apply(R, arguments);
        };
...
/**
 * @ngdoc object
 * @name lbServices.InstrumentTracking
 * @header lbServices.InstrumentTracking
 * @object
 *
 * @description
 *
 * A $resource object for interacting with the `InstrumentTracking` model.
 *
 * ## Example
 *
 * See
...
module.factory(
  ...
  ['LoopBackResource', 'LoopBackAuth', '$injector', function(Resource, LoopBackAuth, $injector) {
    var R = Resource(
      urlBase + "/InstrumentTrackings/:id",
      { 'id': '@id' },
      {

        // INTERNAL. Use InstrumentTracking.instrument() instead.
        "prototype$__get__instrument": {
          url: urlBase + "/InstrumentTrackings/:id/instrument",
          method: "GET"
        },
        ...
        /**
         * @ngdoc method
         * @name lbServices.InstrumentTracking#create
         * @methodOf lbServices.InstrumentTracking
         *
         * @description
         *
         * Create a new instance of the model and persist it into the data source.
         ...
         * <em>
         * (The remote method definition does not provide any description.
         * This usually means the response is a `InstrumentTracking` object.)
         * </em>
         */
        "create": {
          url: urlBase + "/InstrumentTrackings",
          method: "POST"
        },

        /**
         * @ngdoc method
         * @name lbServices.InstrumentTracking#createMany
         * @methodOf lbServices.InstrumentTracking
         *
         * @description
         *
        ...
        /**
         * @ngdoc method
         * @name lbServices.InstrumentTracking#upsert
         * @methodOf lbServices.InstrumentTracking
         *
         * @description
         *
        ...
        /**
         * @ngdoc method
         * @name lbServices.InstrumentTracking#exists
         * @methodOf lbServices.InstrumentTracking
         *
         * @description
         *
         ...
         */
        "exists": {
          url: urlBase + "/InstrumentTrackings/:id/exists",
          method: "GET"
        },

        /**
         * @ngdoc method
         * @name lbServices.InstrumentTracking#findById
         * @methodOf lbServices.InstrumentTracking
         *
         * @description
         *
         ...
         */
        "findById": {
          url: urlBase + "/InstrumentTrackings/:id",
          method: "GET"
        },

        /**
         * @ngdoc method
         * @name lbServices.InstrumentTracking#find
         * @methodOf lbServices.InstrumentTracking
         *
         * @description
         *
        ...
        /**
         * @ngdoc method
         * @name lbServices.InstrumentTracking#findOne
         * @methodOf lbServices.InstrumentTracking
         *
         * @description
         *
         ...
         */
        "findOne": {
          url: urlBase + "/InstrumentTrackings/findOne",
          method: "GET"
        },

        /**
         * @ngdoc method
         * @name lbServices.InstrumentTracking#updateAll
         * @methodOf lbServices.InstrumentTracking
         *
         * @description
         *
         ...
         */
        "updateAll": {
          url: urlBase + "/InstrumentTrackings/update",
          method: "POST"
        },

        /**
         * @ngdoc method
         * @name lbServices.InstrumentTracking#deleteById
         * @methodOf lbServices.InstrumentTracking
         *
         * @description
         *
        ...
        /**
         * @ngdoc method
         * @name lbServices.InstrumentTracking#count
         * @methodOf lbServices.InstrumentTracking
         *
         * @description
         *
         ...
         */
        "count": {
          url: urlBase + "/InstrumentTrackings/count",
          method: "GET"
        },

        /**
         * @ngdoc method
         * @name lbServices.InstrumentTracking#prototype$updateAttributes
         * @methodOf lbServices.InstrumentTracking
         *
         * @description
         *
        ...
        /**
         * @ngdoc method
         * @name lbServices.InstrumentTracking#createChangeStream
         * @methodOf lbServices.InstrumentTracking
         *
         * @description
         *
         ...
         */
        "createChangeStream": {
          url: urlBase + "/InstrumentTrackings/change-stream",
          method: "POST"
        },
      }
    );
        ...
        /**
         * @ngdoc method
         * @name lbServices.InstrumentTracking#updateOrCreate
         * @methodOf lbServices.InstrumentTracking
         *
         * @description
         *
        ...
        /**
         * @ngdoc method
         * @name lbServices.InstrumentTracking#update
         * @methodOf lbServices.InstrumentTracking
         *
         * @description
         *
        ...
        /**
         * @ngdoc method
         * @name lbServices.InstrumentTracking#destroyById
         * @methodOf lbServices.InstrumentTracking
         *
         * @description
         *
        ...
        /**
         * @ngdoc method
         * @name lbServices.InstrumentTracking#removeById
         * @methodOf lbServices.InstrumentTracking
         *
         * @description
         *
    ...
    /**
    * @ngdoc property
    * @name lbServices.InstrumentTracking#modelName
    * @propertyOf lbServices.InstrumentTracking
    * @description
    * The name of the model represented by this $resource,
    * i.e. `InstrumentTracking`.
    */
    R.modelName = "InstrumentTracking";


        /**
         * @ngdoc method
         * @name lbServices.InstrumentTracking#instrument
         * @methodOf lbServices.InstrumentTracking
         *
         * @description
         *
         ...
         * </em>
         */
        R.instrument = function() {
          var TargetResource = $injector.get("Instrument");
          var action = TargetResource["::get::InstrumentTracking::instrument"];
          return action.apply(R, arguments);
        };

        /**
         * @ngdoc method
         * @name lbServices.InstrumentTracking#user
         * @methodOf lbServices.InstrumentTracking
         *
         * @description
         *
        ...
        R.user = function() {
          var TargetResource = $injector.get("Client");
          var action = TargetResource["::get::InstrumentTracking::user"];
          return action.apply(R, arguments);
        };
  ...
  ['LoopBackResource', 'LoopBackAuth', '$injector', function(Resource, LoopBackAuth, $injector) {
    var R = Resource(
      ...
      { 'id': '@id' },
      {
        ...
        /**
         * @ngdoc method
         * @name lbServices.Rate#createMany
         * @methodOf lbServices.Rate
         *
         * @description
         *
        ...
        /**
         * @ngdoc method
         * @name lbServices.Rate#updateAll
         * @methodOf lbServices.Rate
         *
         * @description
         *
        ...
        /**
         * @ngdoc method
         * @name lbServices.Rate#createChangeStream
         * @methodOf lbServices.Rate
         *
         * @description
         *
    ...
    /**
    * @ngdoc property
    * @name lbServices.Rate#modelName
    * @propertyOf lbServices.Rate
    * @description
    * The name of the model represented by this $resource,
    * i.e. `Rate`.
    */
